...
<head>
  ...
  <title>Charel Chapeaux | Chapeau marriage</title>
  ...
  <!-- BOOTSTRAP  -->
  <link href="/assets/vendor/bootstrap/css/bootstrap-reboot.min.css" rel="stylesheet" />
...
<body>
    ...
    <div class="row p-3">
          ...
          <div class="swiper-wrapper p-md-3">
            <div class="swiper-slide">
              <div class="image-holder mb-3" enlarge>
                <img 
                 src="/assets/images/items/chapeaux-14.jpg" 
                  alt="Chapeau pour mariage" 
                  class="img-fluid"
                >
              </div>
            </div>
      ...
      <div class="col-md-6">
        <h4 class="text-uppercase text-left">
          Chapeau pour marriage rouge
        </h4>

        <p>
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Numquam quidem nam voluptates a pariatur quae.
        </p>
        <hr>

        <p>
          <h6 class="text-uppercase text-left opacity-75">
            <s style="text-decoration:line-through brown 2px">
              18.000 F
            </s>
          </h6>
  ...
  <section id="caps-proposition" class="new-arrival product-carousel pt-2 pb-5 position-relative overflow-hidden">
    <div class="container">
